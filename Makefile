...
#main : main.o ckvs_crypto.o ckvs_io.o ckvs_local.o ckvs_utils.o error.o
...
SRCS = cryptkvs.c error.c ckvs_local.c ckvs_utils.c ckvs_io.c ckvs_crypto.c ckvs_client.c ckvs_rpc.c ckvs_httpd.c
...
cleanCall:
	...
	./cryptkvs small.ckvs set thekey 1 test.txt
	./cryptkvs small.ckvs get thekey 1
	cp ../provided/small.ckvs ../done/
...
cleanNew:
	...
	echo
	./cryptkvs small.ckvs new phi pwd
	./cryptkvs small.ckvs get phi pwd
	echo
	./cryptkvs small.ckvs new two pwd
	./cryptkvs small.ckvs get two pwd
	echo
	./cryptkvs small.ckvs stats
	cp ../provided/small.ckvs ../done/
...
cleanAll:
	make clean
	make mrproper -C $(LIBMONGOOSEDIR)
