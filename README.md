...
This project was conducted as part of the [CS-210](https://edu.epfl.ch/coursebook/fr/projet-programmation-systeme-CS-212) course. 
It is a project exclusively coded in C, and it was thought for groups of 2 students who were beginning to learn this language. This project covers most of the notions of C development.<br>

Just below you can find the description of the project in french<br>
